...
class YearBarChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final maxValue = [...incomeTotals, ...expenseTotals]
    ...
    if (maxValue == 0) {
      return Container(
        ...
        child: Center(
          child: Text('Sem dados para o ano selecionado',
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text((maxValue * 0.66).toStringAsFixed(0),
                          style: TextStyle(fontSize: 10, color: Colors.grey[600])),
                      Text((maxValue * 0.33).toStringAsFixed(0),
                          style: TextStyle(fontSize: 10, color: Colors.grey[600])),
                      Text('0',
                          style: TextStyle(fontSize: 10, color: Colors.grey[600])),
                    ],
